      ...
      <table class="table table-striped table-condensed">
        ...
        <?php 
          ...
          echo "<tr><td>$no</td>
                    ...
                    <td><a style='color:#ab0534; font-size:18px' href='".base_url()."produk/detail/$row[produk_seo]'><b>$row[nama_produk]</b></a>
                        <br><span style='color:#31708f; font-size:12px'>".$row[nama_varian]."</span>
