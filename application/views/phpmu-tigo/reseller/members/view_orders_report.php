<p class='sidebar-title text-danger produk-title'> Laporan Data Pesanan Anda</p>
              ...
              echo "<a class='btn btn-info btn-xs' title='Detail data pesanan' href='".base_url()."members/keranjang_detail/$row[id_penjualan]'><class='btn btn-default btn-xs'>Detail Order</a></td>
                          </tr>
