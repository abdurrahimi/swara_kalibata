<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_dokter',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden'  value='$rows[id_dokter]' name='id'>";
                    ...
                    <tr><th scope='row'>Nama Dokter</th><td><input class='form-control' type='text' name='c' value='$rows[nama_dokter]'></td></tr>
                    ...
                    <tr><th scope='row'>Spesialis</th><td><input class='form-control' type='text' name='g' value='$rows[spesialis]'></td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='dokter'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
