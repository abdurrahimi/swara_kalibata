<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/tambah_dokter',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Nama Dokter</th>                <td><input class='form-control' type='text' name='c'></td></tr>
                    ...
                    <tr><th scope='row'>Spesialis</th>                     <td><input class='form-control' type='text' name='g'></td></tr>
