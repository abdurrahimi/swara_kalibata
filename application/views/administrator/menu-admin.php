        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <?php 
                    ...
                    $cek=$this->model_app->umenu_akses("supplier",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/dokter'><i class='fa fa-circle-o'></i> Data Dokter</a></li>";
                    }
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-pencil"></i> <span>Modul SPK</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
                if($this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/gejala'><i class='fa fa-circle-o'></i> Gejala</a></li>";
                }

                if($this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/solusi'><i class='fa fa-circle-o'></i> Solusi</a></li>";
                }

                if($this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/rule'><i class='fa fa-circle-o'></i> Rule</a></li>";
                }
