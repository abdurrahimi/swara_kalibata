            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Pembelian Ke Forsheo + History Stok Produk anda</h3>
                              ...
                              <td><center>
                                ...
                                if ($row['proses']=='0'){
                                  echo "<a class='btn btn-success btn-xs' title='Konfirmasi Pemabayaran' href='".base_url().$this->uri->segment(1)."/konfirmasi_pembayaran/$row[id_penjualan]'> Konfirmasi Pembayaran</a>
                                        <a class='btn btn-warning btn-xs' title='Edit Data' href='".base_url().$this->uri->segment(1)."/edit_pembelian/$row[id_penjualan]'><span class='glyphicon glyphicon-edit'></span> Edit</a>
                                  ...
                                  echo "<a class='btn btn-default btn-xs' title='Konfirmasi Pemabayaran' href='#' onclick=\"return alert('Maaf, Transaksi ini sudah di konfirmasi untuk pembayarannya!')\"> Konfirmasi Pembayaran</a>
                                        <a class='btn btn-default btn-xs' title='Edit Data' href='#' onclick=\"return alert('Maaf, Transaksi ini sudah di proses dan tidak bisa di-edit!')\"><span class='glyphicon glyphicon-edit'></span> Edit</a>
