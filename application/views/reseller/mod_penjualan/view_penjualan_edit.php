            <div class="col-xs-12">  
              <div class="box">
                ...
                ?>
                  <input type='hidden' name='nama_pembeli' value='<?=$rows['nama_pembeli'];?>'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Nama Konsumen</th><td>
                    <?php if ($rows['id_konsumen'] != 0) { ?>
                    <select class='combobox form-control' name='b'>
                        <?php 
                        ...
                        <?php } else { ?>
                          <input type='text' class='form-control' value='<?php echo "$rows[nama_pembeli]"; ?>' name='b'>
                        <?php } ?>    
                    </td></tr>
