        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <?php
                        echo "<li><a href='".base_url().$this->uri->segment(1)."/pembelian'><i class='fa fa-circle-o'></i> Pembelian Ke Forsheo</a></li>";
                        echo "<li><a href='".base_url().$this->uri->segment(1)."/penjualan'><i class='fa fa-circle-o'></i> Penjualan Online</a></li>";
                        echo "<li><a href='".base_url().$this->uri->segment(1)."/pos'><i class='fa fa-circle-o'></i> Point Of Sales</a></li>";
